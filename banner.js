...
function mudaImg(i) {
	...
	// document.getElementById("banner_img_").setAttribute("class", "");
	// document.getElementById("banner_img_").setAttribute("class", "");
	document.getElementById("banner_img_" + img[indice]).setAttribute("class", "hover");
	
	document.getElementById("banner_img").innerHTML = "<img src='banner_img/"+ img[indice] +".jpg' width='500' height='300' border='0' alt='Banner'>";
